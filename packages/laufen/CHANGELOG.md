...
- 36a6a3d: Redesign workspace detection to use lauf.config.ts files as the sole workspace boundary, replacing package manager detection (pnpm-workspace.yaml, etc.).
